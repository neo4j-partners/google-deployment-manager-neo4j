...
out because of recent package naming, if you want v4.3.6, you need to install
`1:4.3.6`.
...
```
$ gcloud compute images describe neo4j-enterprise-1-4-3-6-apoc-bloom --project launcher-public
...
gcloud compute instances create my-neo4j-instance \
    --image neo4j-enterprise-1-4-3-6 \
    --tags neo4j \
